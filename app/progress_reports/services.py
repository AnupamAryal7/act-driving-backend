...
#             raise HTTPException(
#                 status_code=status.HTTP_404_NOT_FOUND,
#                 detail="No progress report found for this user and course"
#             )
...
#                 detail="Progress report already exists for this user and course"
#             )
...
#         """
#         Update only the progress percentage and auto-update status
#         """
...
#     @staticmethod
#     def delete_course_reports(db: Session, course_id: int) -> None:
#         """
#         Delete all progress reports for a course
#         """
#         db.query(ProgressReport).filter(ProgressReport.course_id == course_id).delete()
#         db.commit()
